...
class StarCalendarScreenlet(screenlets.Screenlet):
    """
    ...
    mypath = sys.argv[0][:sys.argv[0].find('StarCalendarScreenlet.py')].strip()
...
if __name__ == "__main__":
    ...
    screenlets.session.create_session(StarCalendarScreenlet)
